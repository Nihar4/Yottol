  ...
  return (
    <div className="swift-login-main">
      ...
      <div className="swift-login">
        ...
        {location.pathname === "/login" && <Login_main />}
        {location.pathname === "/login/pin" && <Login_Pin />}
        {location.pathname === "/login/reset" && <Login_Reset />}
        {location.pathname === "/login/resetsuccessful" && (
          <Login_ResetSuccessful />
        )}
      </div>
    </div>
  );
